...
st.title("🌍 Eco-Guard - Telangana Forest Monitoring")
st.caption("Forest monitoring & change detection for Telangana only")

col_left, col_right = st.columns([0.34, 0.66], gap="large")

with col_left:
    with st.container(border=True):
        st.markdown("### Telangana Forest Regions")
...
with col_right:
    ...
    telangana_min_lat, telangana_max_lat = 12.5, 19.9
    telangana_min_lon, telangana_max_lon = 73.7, 84.7
    ...
    m.fit_bounds([
        [telangana_min_lat, telangana_min_lon],
        [telangana_max_lat, telangana_max_lon]
    ])
